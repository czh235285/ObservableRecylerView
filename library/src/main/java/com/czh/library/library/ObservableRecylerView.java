...
public class ObservableRecylerView extends RecyclerView implements Scrollable{
    ...
    private OnScrollListener mScrollListener =new OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if (mOriginalScrollListener != null) {
                mOriginalScrollListener.onScrollStateChanged(recyclerView, newState);
            }
        }
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (mOriginalScrollListener != null) {
                mOriginalScrollListener.onScrolled(recyclerView,dx,dy);
            }
    ...
    public ObservableRecylerView(Context context) {
        super(context);
        init();
    }

    public ObservableRecylerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public ObservableRecylerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    @Override
    public void onRestoreInstanceState(Parcelable state) {
        ObservableRecylerView.SavedState ss = (ObservableRecylerView.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ObservableRecylerView.SavedState ss = new ObservableRecylerView.SavedState(superState);
    ...
    private void onScrollChanged() {
        ...
        if (getChildCount() > 0) {
           ...
           ;
            ...
            for (int i = linearManager.findFirstVisibleItemPosition(), j = 0; i <= linearManager.findLastVisibleItemPosition(); i++, j++) {
